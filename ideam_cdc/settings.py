...
IDEAM_TEMPORIZER = os.environ.get('IDEAM_TEMPORIZER')
DAYS_ELAPSED_TO_DELETE_EXECUTION_RESULTS = os.environ.get('IDEAM_DAYS_ELAPSED_TO_DELETE_EXECUTION_RESULTS')
IDEAM_ID_ALGORITHM_FOR_CUSTOM_SERVICE = os.environ.get('IDEAM_ID_ALGORITHM_FOR_CUSTOM_SERVICE')
