...
def get_algorithms(value):
	...
	query = 'SELECT * FROM algorithm_algorithm AS alg LEFT JOIN algorithm_version AS ver ON alg.id = ver.id WHERE (ver.publishing_state=\'1\') AND alg.topic_id={}'.format(str(value.id))
