...
def get_algorithms(value):
	...
	query = 'SELECT * FROM algorithm_algorithm AS alg LEFT JOIN algorithm_version AS ver ON alg.id = ver.id WHERE ver.publishing_state={} OR ver.publishing_state={} AND alg.topic_id={}'.format('1', '2', str(value.id))
